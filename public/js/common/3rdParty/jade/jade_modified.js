...
Compiler.prototype = {
  ...
  visitWith: function(with_){
    this.buf.push(''
      + '// with ' + with_.obj + '\n'
      + '(function(){\n'
      + '  with (' + with_.obj + ') {\n' )

    this.visit(with_.block);
...
jade_require.register("nodes/with.js", function(module, exports, jade_require){
...
/**
 * Initialize an `With` node, representing iteration
 *
 * @param {String} obj
 * @param {Block} block
 * @api public
...
var With = module.exports = function With(obj, block) {
  this.obj = obj;
  this.block = block;
};
...
With.prototype = new Node;
With.prototype.constructor = With;

}); // module: nodes/with.js
...
exports.With = jade_require('./with');
...
jade_require.register("nodes/node.js", function(module, exports, jade_require){
...
jade_require.register("nodes/tag.js", function(module, exports, jade_require){
...
jade_require.register("nodes/text.js", function(module, exports, jade_require){
...
jade_require.register("parser.js", function(module, exports, jade_require){
...
var Lexer = jade_require('./lexer')
  , nodes = jade_require('./nodes');
...
Parser.prototype = {
  ...
  parseInclude: function(){
    ...
    */
    ...
    var name = this.expect('include').val.trim()
    ...
    */
    ...
    if(parts.length > 2) {
        throw new Error('the include "' + name + '" has too many path parts');
    }
    var feature, templateName
    if(parts.length === 2){
        var featureName = parts[0]
        feature = Templates.currentApp[featureName]
        templateName = parts[1]
        
        if(!Templates.currentFeature) {
            throw new Error('unexpected lack of Templates.currentFeature for ' + featureName + '/' + templateName)
        }
        if (!Templates.currentFeature.currentDependencies) { Templates.currentFeature.currentDependencies = {} }
        Templates.currentFeature.currentDependencies[featureName] = true
        
    } else {
        feature = Templates.currentFeature
        templateName = parts[0]
    }
    
    if(!(feature) || !feature[templateName]) {
        throw new Error('the include "' + name + '" does not exist');
    }
    var str = feature[templateName].jade
  ...
  parseWith: function(){
    ...
    var tok = this.expect('with')
    var obj = tok.val.trim()
    var block = this.parseBlock()
    var node = new nodes.With(obj, block);
    node.line = this.line();
    return node;
...
jade_require.register("runtime.js", function(module, exports, jade_require){
...
jade_require.register("self-closing.js", function(module, exports, jade_require){
...
jade_require.register("utils.js", function(module, exports, jade_require){
...
exports.text = function(str){
  return interpolate(escape(str));
    ...
    jade_require = ( jade_require || {} ).error = er.toString()
}
